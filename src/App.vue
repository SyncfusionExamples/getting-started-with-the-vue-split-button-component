...
export default{
  ...
  {
    return{
      items: [ { text: "Paste"}, { text: "Paste Special", disabled: true}, { text: "Paste as Formula"},
...
<template>
 <ejs-splitbutton content="Paste" :items="items" iconCss="e-sb-icons e-paste"
                  iconPosition="Top" cssClass="custom-popup-items li" :disabled="true" ></ejs-splitbutton>
</template>
